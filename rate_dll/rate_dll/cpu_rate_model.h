...
namespace OIS_model
{
	...
	__declspec(dllexport) void set_params(double lambda_1, double lambda_21, double lambda_2, double delta_0, double delta_1, double delta_2)
	{
		lambda_1 = lambda_1;
		lambda_21 = lambda_21;
		lambda_2 = lambda_2;
	...
	__declspec(dllexport) double P(double y1_0, double y2_0, double tao)
	{
		return exp(-_A_(tao) - _C1_(tao) * y1_0 - _C2_(tao) * y2_0);
	}

	__declspec(dllexport) double y(double y1_0, double y2_0, double tao)
	{
		if (tao > 0.0)
		{
